...
# Due to the previously discussed issue, instead of replicate combinations being visualized, replicate 5 from mafft and clustalw run data was turned into an MCC tree. Both trees were rooted using strain CP000309.1 (Antiqua). The tree nodes were labeled to show the posterior median estimate of the branch length and saved to Desktop under "pMT-mafft-trimal-beast.png" and "pMT-clustalw-trimal-beast.png".
